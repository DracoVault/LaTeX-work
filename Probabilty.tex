...
\begin{itemize}
    \item 17) \includegraphics{draco.png}

    A probability density function. Find the probability that the variate f(x) as density f(n) will fall in the 2 \leq x \leq 3
\end{itemize}
